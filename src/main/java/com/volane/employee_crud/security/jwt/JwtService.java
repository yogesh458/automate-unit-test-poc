...
public class JwtService {
    ...
    public JwtService(
            @Value("${security.jwt.secret:change-this-secret-to-a-secure-256-bit-value-for-production}") String jwtSecret,
    ...
    private byte[] resolveSecretBytes() {
        ...
        } catch (IllegalArgumentException | io.jsonwebtoken.io.DecodingException exception) {
